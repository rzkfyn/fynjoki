<template>
  <div class="Footer">
      ...
      <div>
        ...
        <ul>
            <li>
              ...
              <span href="#">Jalan Isekai 11 No 22 Kabupaten Tokyo</span>
            </li>
            <li>
              ...
              <span href="#">fynjoki@rzkfyn.me</span>
            </li>
            <li>
              ...
              <span href="#">+62 8123 456 789</span>
            </li>
        </ul>
      </div>
      <div>
    ...
    <div>
      <h4>Copyright &copy; 2022 <a href="/">fynjoki</a> by <a href="https://rzkfyn.me">rzkfyn</a>. All rights reserved.</h4>
    </div>
  </div>
</template>
...
.Footer .links ~ div:last-child {
  padding: 15px 10px;
  border-top: 0.5px #4d4d4d27 solid;
}
